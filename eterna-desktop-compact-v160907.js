 ...
 * Scope: desktop-only compact mode/action bar + embedded Coco mascot.
...
(function(){
  ...
  function ensureMascot(){
    ...
    if(!mascot){
      ...
      mascot.innerHTML='<img src="./coco-flex-eterna.webp?v=1609421" alt="">';
  ...
  style.textContent='@media (min-width:761px){'+
    ...
    '#eternaOverlayV159 .eternaV160CocoFlex img{display:block!important;width:112px!important;height:112px!important;object-fit:cover!important;object-position:center 32%!important;border-radius:28px!important;filter:drop-shadow(0 4px 7px rgba(23,63,89,.10));-webkit-mask-image:radial-gradient(ellipse at center,#000 58%,rgba(0,0,0,.78) 70%,transparent 92%);mask-image:radial-gradient(ellipse at center,#000 58%,rgba(0,0,0,.78) 70%,transparent 92%);animation:eternaCocoFlex1609319 1.8s ease-in-out infinite!important;transform-origin:50% 82%!important;}'+
  ...
  '}'+
  '@keyframes eternaCocoFlex1609319{0%,100%{transform:translateY(2px) rotate(-1deg) scale(1)}35%{transform:translateY(-3px) rotate(1deg) scale(1.035)}70%{transform:translateY(0) rotate(-.5deg) scale(1.015)}}'+
