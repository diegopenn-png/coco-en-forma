(function () {
  ...
  function registerPwa() {
    ...
    window.addEventListener("load", function () {
      navigator.serviceWorker.register(new URL("sw.js?v=160103-r1",document.baseURI).href,{scope:new URL("./",document.baseURI).pathname,updateViaCache:"none"}).then(function (registration) {
