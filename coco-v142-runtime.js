(function () {
  ...
  function registerPwa() {
    ...
    window.__COCO_PWA_REGISTRATION_OWNER__ = "runtime-v160100";
    ...
    window.addEventListener("load", function () {
      navigator.serviceWorker.register(new URL("sw.js?v=160104-r1",document.baseURI).href,{scope:new URL("./",document.baseURI).pathname,updateViaCache:"none"}).then(function (registration) {
