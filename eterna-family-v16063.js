/* ETERNA v160.63 · Zona Familiar: acceso directo tras PIN + menor carga de arranque
 * Preserva suscripción arriba, legal al final e informe con nombre capitalizado.
 * Optimiza el arranque: no hace sondeos de Zona Familiar si no está abierta.
 * Sin MutationObserver nuevo. No modifica Worker, Stripe, Supabase ni memoria pedagógica.
 */
(function(root){
  "use strict";
  if(root.__ETERNA_FAMILY_V16063__)return;
  root.__ETERNA_FAMILY_V16063__=true;

  var VERSION="160.63-family-fast";
  var retryTimers=[];
  ...
  function install(){
    ...
    root.ETERNA_FAMILY_V16063=Object.freeze({
      version:VERSION,
