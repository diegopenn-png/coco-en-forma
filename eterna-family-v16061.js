/* ETERNA v160.61 · Zona Familiar: suscripción arriba + legal al final + nombre de informe capitalizado
 * Capa aditiva. No modifica Worker, Stripe, Supabase ni memoria pedagógica.
 * Sin MutationObserver nuevo: reacciona a los accesos/acciones de Zona Familiar con reintentos acotados.
 */
(function(root){
  "use strict";
  if(root.__ETERNA_FAMILY_V16061__)return;
  root.__ETERNA_FAMILY_V16061__=true;

  var VERSION="160.61-family-zone";
  var retryTimers=[];
  ...
  function scheduleFamilyLayout(){
    clearRetries();
    [0,120,300,650,1100,1800,2800].forEach(function(ms){
  ...
  function install(){
    ...
    scheduleFamilyLayout();
    root.ETERNA_FAMILY_V16061=Object.freeze({
      version:VERSION,
