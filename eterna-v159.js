...
(function(){
  ...
  function injectFinal3Styles(){
    ...
    style.textContent=[
      ...
      "#cocoApp .cocoHomeFinal3{display:grid;gap:18px;margin:18px 0 26px;min-width:0}",
      "#cocoApp .cocoHomeRowFinal3{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px;align-items:stretch;min-width:0}",
      ...
      "#cocoApp .eternaLauncherFinal3{height:100%;min-height:310px!important;padding:18px!important;grid-template-columns:minmax(0,1.05fr) minmax(150px,.95fr)!important;gap:14px!important}",
      ...
      "#cocoApp .eternaLauncherVisualFinal3 img{display:block;width:100%;max-width:430px;height:auto;aspect-ratio:1200/630;object-fit:cover;border-radius:17px;box-shadow:0 12px 28px rgba(23,57,75,.16)}",
      ...
      "@media(max-width:900px){#cocoApp .cocoHomeRowFinal3{grid-template-columns:1fr}#cocoApp .eternaLauncherFinal3{grid-template-columns:1fr!important;min-height:0!important}#cocoApp .eternaLauncherVisualFinal3 img{max-width:620px}#cocoApp .cocoHomeBrainFinal3{min-height:220px}}",
