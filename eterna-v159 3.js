...
(function(){
  ...
  async function injectFamilyCard(force){
    ...
    /* FINAL4 CIERRE · El PIN protege TODA la Zona Familiar.
       Eterna no se muestra en la pantalla "Acceso familiar".
       Solo se inserta después de validar el PIN, cuando ya está abierto
       el informe familiar / Mapa de fortalezas. */
    var familyModal=body.closest(".cocoFamilyV129");
    var familyTitle=familyModal&&familyModal.querySelector("#cocoFamilyV129Title");
    if(familyTitle&&/acceso\s+familiar/i.test(String(familyTitle.textContent||"")))return;
