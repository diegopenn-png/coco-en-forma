...
(function(root){
  'use strict';
  const VERSION='library-first-v6-traceable';
  ...
  root.EternaOwnedLibrary=Object.freeze({version:VERSION,release_id:'eterna-library-2026.09-v6-310-traceable-12c672',school,appropriate,protocol,cordial,protocols:PROTOCOLS,exactLesson,owned,clientTurn,decision,question,contextText});
})(globalThis);
