...
test("full intelligence is preserved while age adapts delivery and risk boundaries", () => {
  ...
  assert.deepEqual(JSON.parse(JSON.stringify(api.modelConfiguration({}))), {
    ...
    vision: { grounding_service: null, model: "gpt-5.6-sol", cloudflare_fallback_model: "@cf/llava-hf/llava-1.5-7b-hf", structuring_model: "gpt-5.6-sol", fallback_model: "gpt-5.6-sol", reasoning_effort: "high", service_tier: "default" },
