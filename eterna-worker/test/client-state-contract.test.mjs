...
test("web entrypoint and Service Worker invalidate the corrected assets together", () => {
  ...
  assert.match(index, /eterna-v159\.js\?v=160938/);
  assert.match(bootstrap, /eterna-experience-v160\.js\?v=160937/);
  assert.match(index, /coco-v144-core\.js\?v=15001/);
  assert.match(serviceWorker, /CACHE_VERSION="coco-en-forma-v160\.93\.8-family-cleanup-r1"/);
