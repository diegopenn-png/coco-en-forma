-- COCO EN FORMA v160.110 · rollback no destructivo
-- Reactiva la lectura histórica v153. No elimina columnas, filas ni metadatos.

begin;

update public.coco_scoring_seasons
set active = false
...
drop function if exists public.registrar_partida_equilibrada_v160110(text, integer, smallint, numeric);
