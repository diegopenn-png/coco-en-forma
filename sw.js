/* Coco en Forma · Service Worker v160.95.7 · Reto Coco visual integration */
const CACHE_VERSION="coco-en-forma-v160.95.7-reto-coco-visual-integration-r1";
...
const CORE=["./index.html","./manifest.webmanifest","./manifest.json","./supabase-js-2.112.3.min.js","./coco-v142-content-extension.js","./coco-v142-runtime.js","./coco-v142-unified.js","./coco-v144-content.js","./coco-v144-core.js","./coco-v152-pwa.js",COCO_BOOTSTRAP_PATH,"./coco-v155-identity.js",PRODUCT_UX_PATH,RETO_2026_PATH,"./coco-excellence-v160934.js","./eterna-state-contract-v3.js",ETERNA_CORE_PATH,"./eterna-v159.css",ETERNA_EXPERIENCE_PATH,ETERNA_HOTFIX_PATH,ETERNA_DESKTOP_COMPACT_PATH,ETERNA_VOICE_AUTOCUT_PATH,"./eterna-marketing-attribution-v1.js","./coco-flex-eterna.jpg","./reto-coco-2026-v160955.jpg","./coco-v144-professional.css","./coco-v147-refinements.css","./coco-v149-refinements.css","./coco-v152-refinements.css","./coco-v153-release.css","./icon-192.png","./icon-512.png","./icon-maskable-192.png","./icon-maskable-512.png","./apple-touch-icon.png","./favicon.png"];
...
async function withRetoScript(response){
  ...
  try{
    ...
    if(html.indexOf('id="coco-reto-2026-direct"')===-1){
      const tag='<script id="coco-reto-2026-direct" src="./coco-reto-2026-v160908.js?v=160957"></script>';
