/* Coco en Forma · Service Worker v160 FINAL4.22 · CTA único + onboarding trial */
const CACHE_VERSION="coco-en-forma-v160.0.0-final4.22";
...
const ESSENTIAL=[
  ...
  "./eterna-v159.js","./eterna-v159.css","./eterna-experience-v160.js","./eterna-family-v16061.js","./eterna-onboarding-v16062.js","./eterna.html","./eterna-social.png","./og-coco.jpg","./share/eterna.png",
...
self.addEventListener("fetch",event=>{
  ...
  const critical=/\/(eterna-v159\.(js|css)|eterna-experience-v160\.js|eterna-family-v16061\.js|eterna-onboarding-v16062\.js|eterna\.html|coco-v152-pwa\.js|coco-v153-fixes\.js|coco-v155-identity\.js)$/.test(url.pathname);
