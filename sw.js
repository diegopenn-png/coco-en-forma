/* Coco en Forma · Service Worker v160 FINAL4.25 · onboarding Eterna final */
const CACHE_VERSION="coco-en-forma-v160.0.0-final4.25";
...
const ESSENTIAL=[
  ...
  "./eterna-v159.js","./eterna-v159.css","./eterna-experience-v160.js","./eterna-family-v16065.js","./eterna-onboarding-v16065.js","./eterna.html","./eterna-social.png","./og-coco.jpg","./share/eterna.png",
...
self.addEventListener("fetch",event=>{
  ...
  const bootstrap=/\/(coco-v153-fixes\.js|coco-v155-identity\.js)$/.test(url.pathname);
  if(documentRequest||bootstrap){event.respondWith(networkFirst(event));return}
