/* Coco en Forma · Reto Coco 2026 · v160.95.7
...
(function(){
  'use strict';
  if(window.__COCO_RETO_2026_V160957__) return;
  window.__COCO_RETO_2026_V160957__=true;

  var style=document.createElement('style');
  style.id='coco-reto-2026-v160957-style';
  style.textContent=`
  ...
  function card(){
    ...
    img.src='./reto-coco-2026-v160955.jpg?v=160957';
