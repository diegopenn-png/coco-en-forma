/* Coco en Forma · Reto Coco 2026 · v160.95.5
 * Desktop: promo image above existing Coco brand card.
 * Mobile/PWA: promo image before games; existing brand card after games.
 */
(function(){
  'use strict';
  if(window.__COCO_RETO_2026_V160955__) return;
  window.__COCO_RETO_2026_V160955__=true;

  var style=document.createElement('style');
  style.id='coco-reto-2026-v160955-style';
  style.textContent=`
  ...
  #cocoReto2026 img{display:block;width:100%;height:auto;aspect-ratio:19/25;object-fit:cover;border-radius:22px;box-shadow:0 8px 22px rgba(22,56,78,.12);image-rendering:auto}
  @media(min-width:761px){#cocoReto2026{max-width:100%;margin:0 0 14px}#cocoApp .marcaHeroe,#cocoApp .cocoHomeBrainFinal3{align-self:stretch!important;height:100%!important;min-height:100%!important;justify-content:flex-start!important}#cocoApp .cocoHomeBrainFinal3 .loginPoster{display:block!important;width:100%!important;height:auto!important;max-height:none!important;aspect-ratio:19/25!important;object-fit:cover!important;image-rendering:auto!important}}
  ...
  function card(){
    ...
    img.src='./reto-coco-2026-v160955.jpg?v=160955';
