...
(function(root){
  ...
  function injectStyles(){
    ...
    s.textContent=[
      ...
      "#cocoApp .cocoMiniJuego[data-coco-excellence='1']{grid-template-columns:82px minmax(0,1fr)!important;grid-template-rows:auto auto auto!important;align-content:start;min-height:0!important}",
      "#cocoApp .cocoMiniJuego[data-coco-excellence='1']>.cocoMiniIcono{grid-column:1;grid-row:1/3}",
      "#cocoApp .cocoMiniJuego[data-coco-excellence='1']>b{grid-column:2;grid-row:1;align-self:end}",
      "#cocoApp .cocoMiniJuego[data-coco-excellence='1']>.cocoMiniEstado{grid-column:2;grid-row:2;align-self:start}",
      "#cocoApp .cocoMiniJuego[data-coco-excellence='1']>.cocoExcellenceMeta{grid-column:1/-1;grid-row:3;width:100%;min-width:0;box-sizing:border-box;justify-content:flex-start;flex-wrap:nowrap;margin:7px 0 0}",
      "#cocoApp .cocoMiniJuego[data-coco-excellence='1']>.cocoExcellenceMeta span:first-child{flex:0 0 auto}",
      "#cocoApp .cocoMiniJuego[data-coco-excellence='1']>.cocoExcellenceMeta span:last-child{flex:1 1 auto;min-width:0;border-radius:12px}",
      ...
      "#cocoApp .cocoMiniJuego[data-coco-kind='tool']{grid-template-rows:auto auto auto auto!important}",
      "#cocoApp .cocoMiniJuego[data-coco-kind='tool']>.cocoExToolLabel{grid-column:1/-1;grid-row:1;justify-self:center;margin:0 0 7px!important}",
      "#cocoApp .cocoMiniJuego[data-coco-kind='tool']>.cocoMiniIcono{grid-row:2/4}",
      "#cocoApp .cocoMiniJuego[data-coco-kind='tool']>b{grid-row:2}",
      "#cocoApp .cocoMiniJuego[data-coco-kind='tool']>.cocoMiniEstado{grid-row:3}",
      "#cocoApp .cocoMiniJuego[data-coco-kind='tool']>.cocoExcellenceMeta{grid-row:4}",
      ...
      "@media(prefers-reduced-motion:reduce){#cocoApp .cocoExGuide{transition:none!important}}"
