/* Coco en Forma · v160 FINAL4.20 · compatibilidad sin observación global */
(function(root){
  "use strict";
  ...
  function loadEternaExperience(){
    if(root.__ETERNA_EXPERIENCE_V16060_LOADER__)return;
    root.__ETERNA_EXPERIENCE_V16060_LOADER__=true;
    var s=document.createElement("script");
    s.src="./eterna-experience-v160.js?v=16060";
    s.async=true;
    s.dataset.cocoModule="eterna-experience-v16060";
    s.onerror=function(){root.__ETERNA_EXPERIENCE_V16060_LOADER__=false};
    document.head.appendChild(s)
  }
  function flush(){raf=0;var nodes=Array.from(queued);queued.clear();nodes.forEach(processNode);root.COCO_VERSION="2026-08-24-v160-final4.20"}
  function queue(node){if(node)queued.add(node);if(!raf)raf=requestAnimationFrame(flush)}
  function initial(){var app=document.getElementById("cocoApp");if(app)processNode(app);loadEternaExperience();root.COCO_VERSION="2026-08-24-v160-final4.20"}
