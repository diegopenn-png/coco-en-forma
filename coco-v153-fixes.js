(function(root){
  ...
  function apply(){raf=0;purgeRetired();document.querySelectorAll(".cocoGameCard[data-coco-juego]").forEach(function(card){var id=idOf(card);cleanScoreNoise(card);scoreStatus(card,id);fixPadel(card,id)});root.COCO_VERSION="2026-08-20-v153.0-simplificada-compartible"}
