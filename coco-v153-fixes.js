...
(function(root){
  ...
  function reportDocumentHtml(model){
    var core=reportCoreHtml(model),returnUrl="/";
  ...
  function reportKitCss(documentMode){return [
    ...
    '@media(max-width:700px){.cocoV16083Document{margin:0;border-radius:0;padding:16px}.cocoV16083DocTop{align-items:flex-start;flex-wrap:wrap}.cocoV16085DocActions{width:100%;justify-content:flex-start}.cocoV16083DocTop button{width:100%;max-width:280px}.cocoV16083ReportHeader{display:grid}.cocoV16083Person{text-align:left;min-width:0}.cocoV16085HeaderActions{justify-content:flex-start}.cocoV16085HeaderActions button{width:100%;max-width:260px;white-space:normal}.cocoV16083Hero{grid-template-columns:auto 1fr}.cocoV16083HeroGauge{grid-column:1/-1}.cocoV16083Metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.cocoV16083PanelGrid,.cocoV16083GroupGrid{grid-template-columns:1fr}.cocoV16083BarList article{grid-template-columns:1fr 45px}.cocoV16083Track{grid-column:1/-1;grid-row:2}.cocoV16083BarList article>strong{grid-column:2;grid-row:1}.cocoParticipationV16084{grid-template-columns:auto minmax(0,1fr)!important;width:calc(100% - 20px)!important;padding:13px!important}.cocoParticipationV16084 .cocoBotonJuego,.cocoParticipationV16084>.btn{grid-column:1/-1!important;width:min(100%,240px)!important;min-width:0!important;justify-self:center!important}.cocoFreemiumV16084{grid-template-columns:1fr!important}}',
