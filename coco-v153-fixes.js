...
(function(root){
  ...
  function reportKitCss(documentMode){return [
    ...
    '@media(max-width:700px){.cocoV16083Document{margin:0;border-radius:0;padding:16px}.cocoV16083DocTop{align-items:flex-start;flex-wrap:wrap}.cocoV16083DocTop button{width:100%;max-width:280px}.cocoV16083ReportHeader{display:grid}.cocoV16083Person{text-align:left;min-width:0}.cocoV16085HeaderActions{justify-content:flex-start}.cocoV16085HeaderActions button{width:100%;max-width:260px;white-space:normal}.cocoV16083Hero{grid-template-columns:auto 1fr}.cocoV16083HeroGauge{grid-column:1/-1}.cocoV16083Metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.cocoV16083PanelGrid,.cocoV16083GroupGrid{grid-template-columns:1fr}.cocoV16083BarList article{grid-template-columns:1fr 45px}.cocoV16083Track{grid-column:1/-1;grid-row:2}.cocoV16083BarList article>strong{grid-column:2;grid-row:1}.cocoParticipationV16084{grid-template-columns:auto minmax(0,1fr)!important;width:calc(100% - 20px)!important;padding:13px!important}.cocoParticipationV16084 .cocoBotonJuego,.cocoParticipationV16084>.btn{grid-column:1/-1!important;width:min(100%,240px)!important;min-width:0!important;justify-self:center!important}.cocoFreemiumV16084{grid-template-columns:1fr!important}}',
  ...
  function placeReportExportAction(scope,button){if(!scope)return false;button=button||scope.querySelector("[data-report-export],[data-et-export]");var header=scope.querySelector(".cocoV16083ReportHeader"),person=header&&header.querySelector(".cocoV16083Person");if(!button||!person)return false;if(button.textContent!=="Exportar PDF")button.textContent="Exportar PDF";if(!button.classList.contains("cocoV16085HeaderExport"))button.classList.add("cocoV16085HeaderExport");var actions=person.querySelector(".cocoV16085HeaderActions");if(!actions){actions=document.createElement("div");actions.className="cocoV16085HeaderActions";person.appendChild(actions)}if(button.parentElement!==actions)actions.appendChild(button);var inline=scope.querySelector(".cocoV16083InlineActions");if(inline&&!inline.children.length)inline.remove();return true}
  ...
  function relevantNode(node){
    if(!node||node.nodeType!==1)return false;var selector="[data-coco-juego],.cocoGameCard,.cocoSuggestionCard,.cocoMiniSuggestion,#retosCard,.retosCard,#eternaLauncherV159,#cocoHomeFinal3,.cocoFamilyV129,.eternaV159FamilyCard,.eternaV159FamilyStatus,.eternaV159Buttons,.eternaV160ProgressPanel,.cocoFamilyHero,.cocoFamilyStats,.cocoFamilyBars,.cocoFamilyDomains,.cocoFamilyCoverage,.cocoFamilyInsight,.cocoFamilyEvidence,.cocoV16083ReportCore,.cocoV16083InlineActions,[data-et-export],[data-report-export]";
