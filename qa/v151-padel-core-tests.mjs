...
vm.runInContext(fs.readFileSync(path.join(rootDir, "coco-v151-padel.js"), "utf8"), context, { filename: "coco-v151-padel.js" });
const P = window.CocoPadelV151;
assert.ok(P, "API CocoPadelV151 no cargada");
...
console.log("8/8 núcleo Coco Pádel v151 superado: jugadores, resultado por sets, sets/games, puntos, perfil, corrección y borrado/recalculo.");
