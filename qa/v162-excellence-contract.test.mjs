...
test("entrypoint, preview and PWA cache ship the exact excellence version",()=>{
  ...
  assert.match(html,/eterna-v159\.js\?v=160112/);
  assert.match(html,/coco-v144-core\.js\?v=15001/);
  assert.match(sw,/coco-en-forma-v160\.100\.12-eterna-subject-intake-r1/);
  ...
  assert.match(workflow,/frontend 160\.99\.23-subject-intake/);
