...
test("the fixed microphone assets invalidate browser and PWA caches together", () => {
  ...
  assert.match(serviceWorker, /coco-en-forma-v160\.93\.10-canonical-expired-checkout/);
  ...
  assert.match(previewWorkflow, /frontend 160\.93\.10-canonical-expired-checkout/);
});
