...
test("Eterna has one canonical Worker entrypoint", () => {
  ...
  assert.match(preview, /payload\.features\?\.distinct_modes === true/);
  assert.match(preview, /payload\.features\?\.mode_contracts_v2 === true/);
  assert.match(preview, /payload\.features\?\.teacher_core_v1 === true/);
  assert.match(preview, /payload\.features\?\.cloudflare_speech_v1 === true/);
  assert.match(preview, /payload\.features\?\.child_safeguarding_interrupt_v1 === true/);
...
test("Eterna coherence and voice contracts stay wired into the PWA", () => {
  ...
  assert.match(serviceWorker, /160\.100\.18-eterna-desktop-composer-r1/);
