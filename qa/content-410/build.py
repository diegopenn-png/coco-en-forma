...
needle='const lessons=JSON.parse(JSON.stringify(box.ETERNA_LIBRARY_CONTENT.lessons))';assert s.count(needle)==1;s=s.replace(needle,needle+'.slice(0,370)');p.write_text(s)
