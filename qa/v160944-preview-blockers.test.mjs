...
test("the browser cache invalidates both repaired frontend modules", () => {
  assert.match(read("index.html"), /eterna-v159\.js\?v=160114/);
  assert.match(read("coco-v153-fixes.js"), /eterna-experience-v160\.js\?v=160108/);
  assert.match(read("sw.js"), /coco-en-forma-v160\.100\.17-eterna-contextual-dialogue-r1/);
