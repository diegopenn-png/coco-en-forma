...
test("Eterna owns the mobile visual viewport while it is open", () => {
  ...
  assert.match(core, /160\.98\.4-portrait-photo-bands/);
...
test("the release invalidates both document and service-worker caches", () => {
  assert.match(read("index.html"), /eterna-v159\.js\?v=160104/);
  assert.match(read("sw.js"), /coco-en-forma-v160\.100\.4-portrait-photo-bands-r1/);
});
