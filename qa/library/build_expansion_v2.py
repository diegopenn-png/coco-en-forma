...
expected={'eterna-worker/src/index.js':'0a142b6705aa1ee4b63562cd59cfc66c8e5702768d5413e46c94106f6e1eb52c','eterna-worker/src/library/runtime-v1.js':'ed83c7f574db28c0e32e996579aed1ac9f03a85e91a2d59ff1cf28eb94c1b976','qa/library/lessons-v1.json':'eb6b80568bef5dd052949033d498cd10e3b2f2514b8ac1d779ada4fdb0168246'}
...
p=W/'eterna-worker/src/library/runtime-v1.js';s=p.read_text().replace("const VERSION='library-first-v1.1'","const VERSION='library-first-v2'").replace("release_id:'"+old_release+"'","release_id:'"+release+"'")
...
s=s[:start]+"    const exact=v=>{const raw=String(v??'').normalize('NFC').replace(/−/g,'-').replace(/\\s+/g,' ').trim();return /[0-9]|^(?:(?:es )?m\\/?s(?:²|2)?|cm(?:²|³)?|m(?:²|³)?|kg|g|mg|s|ms|Hz|N|J|W|Pa|V|A|C|K|mol|L|mL|Ω|°C)$/i.test(raw)?raw:raw.toLocaleLowerCase('es-ES')};"+s[end:]
p.write_text(s)
...
expected_final={'eterna-worker/src/index.js':'8849aeb754f3eaaac69a5b31f39081959ed134770066522e872766f517c98884','eterna-worker/src/library/runtime-v1.js':'7eace07381ecab1025d0cb0c2af56f883539ddfcb5a90f6fb17dc90b9a225aad','eterna-worker/src/library/content-v1.js':'44dd8a3f068de9f6f9b06cef1b6fa19e025ec0c94714ccef498b582ac8fa6143','qa/library/lessons-v1.json':'1cf7c42c9e0d2787c5753df63078d4c134cd6805d81a293128277d50efde06d5'}
