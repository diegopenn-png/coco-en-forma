(function () {
  ...
  if (!content || window.CocoV141ContentAudit) return;
  ...
  window.CocoV141SoupExtra = soupExtra;
  ...
  window.CocoV141MedExtra = Object.freeze(medExtra);

  window.CocoV141ContentAudit = Object.freeze({
    version: "141.0.0",
