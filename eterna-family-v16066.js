/* ETERNA v160.66 · Zona Familiar: autorización y trial sin carreras
...
(function(root){
  "use strict";
  if(root.__ETERNA_FAMILY_V16066__)return;
  root.__ETERNA_FAMILY_V16066__=true;

  var VERSION="160.66-family-launch-final";
  var retryTimers=[];
  ...
  function install(){
    ...
    root.ETERNA_FAMILY_V16066=Object.freeze({
      version:VERSION,
