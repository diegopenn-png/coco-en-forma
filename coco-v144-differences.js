(function (root) {
  ...
  var SCENES = [
    ["workshop", "El taller mecánico", "scenes/scene-workshop-v141.webp?v=1500", [["brain", "el cerebro de Coco", 52, 31, 14, 18, "color", 10, 13], ["beak", "el pico de Coco", 52, 48, 11, 14, "color", 5, 7], ["mug", "la taza", 70, 66, 9, 14], ["lamp", "la lámpara", 48, 10, 18, 20], ["toolbox", "la caja de herramientas", 82.5, 62, 18, 23], ["plant", "la planta", 9, 56, 18, 29]]],
    ["invention-lab", "El laboratorio de inventos", "scenes/scene-invention-lab-v141.webp?v=1500", [["brain", "el cerebro de Coco", 38, 43, 14, 18, "color", 10, 13], ["beak", "el pico de Coco", 38, 57, 11, 14, "color", 5, 7], ["toolbox", "la caja de herramientas", 83, 73, 20, 22], ["cup", "el vaso", 14, 71, 9, 22], ["controls", "las luces del robot", 50, 73, 12, 11], ["lamp", "la lámpara", 31, 11, 16, 21]]],
    ["observatory", "El observatorio de Coco", "scenes/scene-observatory-v141.webp?v=1500", [["brain", "el cerebro de Coco", 45, 44, 14, 18, "color", 10, 13], ["beak", "el pico de Coco", 45, 57, 11, 14, "color", 5, 7], ["mug", "la taza", 10, 79, 11, 18], ["toolbox", "la caja de herramientas", 89, 80, 19, 22], ["lens", "la lente del telescopio", 78, 29, 17, 20], ["chart", "el mapa celeste", 90, 36, 18, 27]]],
    ["tech-library", "La biblioteca tecnológica", "scenes/scene-tech-library-v141.webp?v=1500", [["brain", "el cerebro de Coco", 46, 34, 14, 18, "color", 10, 13], ["beak", "el pico de Coco", 46, 49, 11, 14, "color", 5, 7], ["globe", "el globo", 93, 36, 11, 18], ["cans", "los botes", 29, 69, 11, 13], ["toolbox", "la caja de herramientas", 89, 74, 19, 23], ["mug", "la taza", 30, 60, 9, 14]]],
    ["electric-garage", "El garaje eléctrico", "scenes/scene-electric-garage-v141.webp?v=1500", [["brain", "el cerebro de Coco", 44, 39, 14, 18, "color", 10, 13], ["beak", "el pico de Coco", 44, 52, 11, 14, "color", 5, 7], ["toolbox", "la caja de herramientas", 11, 61, 21, 22], ["mug", "la taza", 94, 74, 10, 17], ["battery", "la batería", 56, 62, 14, 17], ["floor", "la señal del suelo", 53, 82, 12, 11]]],
    ["robotics-studio", "El estudio de robótica", "scenes/scene-robotics-studio-v141.webp?v=1500", [["brain", "el cerebro de Coco", 56, 42, 14, 18, "color", 10, 13], ["beak", "el pico de Coco", 56, 54, 11, 14, "color", 5, 7], ["mug", "la taza", 21, 80, 10, 17], ["toolbox", "la caja de herramientas", 85, 75, 19, 23], ["tools", "los destornilladores", 58, 86, 17, 15], ["lamp", "la lámpara", 44, 11, 16, 21]]],
    ["ocean-lab", "El laboratorio submarino", "scenes/scene-ocean-lab-v141.webp?v=1500", [["brain", "el cerebro de Coco", 43, 40, 14, 18, "color", 10, 13], ["beak", "el pico de Coco", 43, 52, 11, 14, "color", 5, 7], ["canisters", "los depósitos", 17, 65, 15, 16], ["toolbox", "la caja de herramientas", 84, 73, 19, 23], ["mug", "la taza", 68, 69, 9, 15], ["floor", "el aro del suelo", 85, 90, 12, 11]]],
    ["botanical-greenhouse", "El invernadero botánico", "scenes/scene-botanical-greenhouse-v141.webp?v=1500", [["brain", "el cerebro de Coco", 50, 33, 14, 18, "color", 10, 13], ["beak", "el pico de Coco", 50, 47, 11, 14, "color", 5, 7], ["bottle", "la botella", 24, 84, 8, 17], ["cutters", "las tijeras", 71, 86, 16, 12], ["pot", "la maceta", 75, 7, 11, 13], ["notebook", "el cuaderno", 42, 91, 16, 12]]],
    ["music-studio", "El estudio musical", "scenes/scene-music-studio-v141.webp?v=1500", [["brain", "el cerebro de Coco", 52, 40, 14, 18, "color", 10, 13], ["beak", "el pico de Coco", 52, 53, 11, 14, "color", 5, 7], ["bells", "las campanas", 84, 22, 22, 13], ["metronome", "el metrónomo", 65, 67, 11, 27], ["controls", "los controles", 25, 84, 21, 15], ["records", "los discos", 88, 76, 21, 18]]],
    ["space-station", "La estación espacial", "scenes/scene-space-station-v141.webp?v=1500", [["brain", "el cerebro de Coco", 47, 44, 14, 18, "color", 10, 13], ["beak", "el pico de Coco", 47, 57, 11, 14, "color", 5, 7], ["robot", "el robot", 62, 66, 16, 29], ["case", "la caja", 89, 65, 17, 20], ["plant", "la planta", 86, 40, 15, 24], ["tools", "las herramientas", 35, 88, 19, 12]]]
  ].map(function (scene) {
    return { id: scene[0], title: scene[1], src: scene[2], differences: scene[3].map(function (item, index) { return { id: scene[0] + "-" + item[0], key: item[0], sceneId: scene[0], label: item[1], x: item[2], y: item[3], w: Math.max(11, item[4]), h: Math.max(14, item[5]), kind: item[6] || KINDS[index % KINDS.length], forceKind: item[6] || null, visualW: item[7] || null, visualH: item[8] || null }; }) };
  });
  ...
  function materialize(choice, count) {
    return choice.scene.differences.slice(0, count).map(function (base, index) {
      var item = Object.assign({}, base); item.id = base.id + "-v" + (choice.variant + 1); item.kind = base.forceKind || VARIANTS[choice.variant][index]; item.variant = choice.variant;
  ...
  function rectFor(canvas, item) {
    var visualW = Number(item.visualW) || item.w, visualH = Number(item.visualH) || item.h;
    var width = Math.max(8, Math.round(canvas.width * visualW / 100)), height = Math.max(8, Math.round(canvas.height * visualH / 100));
